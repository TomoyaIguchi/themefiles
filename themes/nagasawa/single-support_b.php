        ...
        <div class="modalWrap">
          ...
          <div class="blockWrap modal">
            ...
            <ul class="listBlock actionList">
              <li class="item op"><img src="<?php echo get_template_directory_uri(); ?>/assets/common/img/shop/actionList01.png" height="51" width="293" alt="商品のご購入"></li>
              <li class="item op"><img src="<?php echo get_template_directory_uri(); ?>/assets/common/img/shop/actionList02.png" height="51" width="293" alt="取付工事のご依頼"></li>
              <li class="item op"><img src="<?php echo get_template_directory_uri(); ?>/assets/common/img/shop/actionList03.png" height="51" width="293" alt="修理・交換のご依頼"></li>
            </ul>
          </div>
